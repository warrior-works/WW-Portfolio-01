    ...
    return (
        <div className="info_box shadow_box" >
            <img src={textureImg} alt="bg" className='bg_img' />
                ...
                <Link to="https://github.com/codeaashu" target='_blank' title="Ashutosh Kumar - The Human Version of JavaScript on GitHub">
                ...
                <Link to="https://www.linkedin.com/in/ashutoshkumaraashu/" target='_blank' title="Ashutosh Kumar - The Human Version of JavaScript on LinkedIn">
                ...
                <Link to="https://x.com/warrioraashuu" target='_blank' title="Ashutosh Kumar - The Human Version of JavaScript on X">
                ...
                <Link to="https://www.devdisplay.org/profile/codeaashu" target='_blank' title="Ashutosh Kumar on DevDisplay">
            ...
            {/* <div className='inner_profile_icons shadow_box'>
                ...
                <Link to="https://x.com/warrioraashuu" target='_blank'>
                    <svg width="16px" height="16px" strokeWidth="1.6" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" color="#FFFFFF"><path d="M23 3.01s-2.018 1.192-3.14 1.53a4.48 4.48 0 00-7.86 3v1a10.66 10.66 0 01-9-4.53s-4 9 5 13a11.64 11.64 0 01-7 2c9 5 20 0 20-11.5 0-.278-.028-.556-.08-.83C21.94 5.674 23 3.01 23 3.01z" stroke="#FFFFFF" strokeWidth="1.6" strokeLinecap="round" strokeLinejoin="round"></path></svg>
                </Link>
