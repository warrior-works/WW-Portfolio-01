    ...
    return (
        <div className="info_box shadow_box" >
            <img src={textureImg} alt="bg" className='bg_img' />
                ...
                <Link to="https://github.com/codeaashu" target='_blank' title="aashuu - GitHub">
                ...
                <Link to="https://www.linkedin.com/in/ashutoshkumaraashu/" target='_blank' title="aashuu - LinkedIn">
                ...
                <Link to="https://x.com/warrioraashuu" target='_blank' title="aashuu - X">
                ...
                <Link to="https://www.devdisplay.org/profile/codeaashu" target='_blank' title="aashuu on DevDisplay">
